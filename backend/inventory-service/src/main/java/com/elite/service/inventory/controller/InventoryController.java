...
public class InventoryController {
    ...
    public ResponseEntity<StockReductionResponseDTO> reduceInventoryStock(@PathVariable String productId, @RequestBody StockUpdateRequestDTO stockUpdateRequestDTO) {
        log.info("Inventory Controller - reducing stock for inventory with product-id {}:", productId);
        return new ResponseEntity<>(inventoryService.reduceInventoryStock(productId, stockUpdateRequestDTO), HttpStatus.OK);
    }
